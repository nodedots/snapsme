          ...
          {currentStep === 1 && (
            <form onSubmit={handleSignUpSubmit} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-2">
                <button
                  ...
                  onClick={() => {
                    setSignUpForm({
                      ...
                      emailOrPhone: "alex@acmetrading.com",
                    ...
                    setInvitedStaffList([
                      { displayName: "Marcus Vance", email: "marcus@acmetrading.com", phone: "+1 555-0144" },
                      { displayName: "Sarah Connor", email: "sarah@acmetrading.com", phone: "+1 555-0188" }
                    ]);
                  }}
                  className="text-xs font-mono font-semibold text-[#0f7a52] hover:underline cursor-pointer flex items-center gap-1 order-2 sm:order-1"
                >
                ...
                <button
                  type="submit"
                  className="btn-snap-coral w-full sm:w-auto min-h-[44px] px-6 py-2.5 text-sm font-semibold flex items-center justify-center gap-2 cursor-pointer order-1 sm:order-2"
                >
